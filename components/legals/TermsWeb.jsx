  ...
  return (
    <div className="privacy">
      ...
      <p className="privacy-text">
        ...
        of Freedemy's Website, located at{" "}
        <a
          href="https://free-demy.netlify.app/"
          target="_blank"
          rel="noreferrer"
        >
          https://free-demy.netlify.app/
        </a>
      </p>

      <p className="privacy-text">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Freedemy if you do not agree to take
      ...
      <p className="privacy-heading">Cookies</p>

      <p className="privacy-text">
        We employ the use of cookies. By accessing Freedemy, you agreed to use
        cookies in agreement with the Freedemy's Privacy Policy.{" "}
      </p>
      ...
      <p className="privacy-heading">License</p>

      <p className="privacy-text">
        Unless otherwise stated, Freedemy and/or its licensors own the
        intellectual property rights for all material on Freedemy. All
        intellectual property rights are reserved. You may access this from
        Freedemy for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p className="privacy-sub-heading">You must not:</p>
      <ul>
        <li>Republish material from Freedemy</li>
        <li>Sell, rent or sub-license material from Freedemy</li>
        <li>Reproduce, duplicate or copy material from Freedemy</li>
        <li>Redistribute content from Freedemy</li>
      </ul>

      <p className="privacy-text">
        This Agreement shall begin on the date 03-10-2021.
      </p>

      <p className="privacy-text">
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Freedemy does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Freedemy,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, Freedemy shall not be liable
      ...
      <p className="privacy-text">
        Freedemy reserves the right to monitor all Comments and to remove any
        Comments which can be considered inappropriate, offensive or causes
        breach of these Terms and Conditions.
      </p>

      <p className="privacy-sub-heading">You warrant and represent that:</p>
      ...
      <p className="privacy-text">
        ...
        the hyperlink compensates the absence of Freedemy; and (d) the link is
      ...
      <p className="privacy-text">
        ...
        e-mail to Freedemy. Please include your name, your organization name,
      ...
      <p className="privacy-text">
        No use of Freedemy's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </p>

      <p className="privacy-heading">iFrames</p>
      ...
      <p className="privacy-heading">Content Liability</p>
      ...
      <p className="privacy-heading">Your Privacy</p>

      <p className="privacy-text">Please read Privacy Policy</p>

      <p className="privacy-heading">Reservation of Rights</p>
      ...
      <p className="privacy-heading">Removal of links from our website</p>
      ...
      <p className="privacy-heading">Disclaimer</p>
