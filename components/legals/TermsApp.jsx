...
function TermsApp() {
  ...
  return (
    <div className="privacy">
      ...
      <p className="privacy-text">
        Siddhesh parab is committed to ensuring that the app is as useful and
      ...
      <p className="privacy-text">
        The Freedemy app stores and processes personal data that you have
        ...
        features and it could mean that the Freedemy app won’t work properly or
        at all.
      </p>
      <p className="privacy-text">
      ...
      <p className="privacy-text">
        You should be aware that there are certain things that Siddhesh parab
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Siddhesh
        parab cannot take responsibility for the app not working at full
      ...
      <p className="privacy-text">
        Along the same lines, Siddhesh parab cannot always take responsibility
        ...
        avail the Service, Siddhesh parab cannot accept responsibility.
      </p>
      <p className="privacy-text">
        With respect to Siddhesh parab’s responsibility for your use of the app,
        ...
        make it available to you. Siddhesh parab accepts no liability for any
      ...
      <p className="privacy-text">
        ...
        using the app. Siddhesh parab does not promise that it will always
      ...
      <p className="privacy-heading">Changes to This Terms and Conditions</p>
      <p className="privacy-text">
      ...
      <p className="privacy-text">
        ...
        do not hesitate to contact me at freedemy98@gmail.com.
      </p>
    </div>
  );
}
